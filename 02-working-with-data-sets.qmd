...
help](01-the-basics-of-stata.html#stata-help) will use these data sets.
...
directory](01-the-basics-of-stata.html#working-directory) section, Stata can see
...
[discarding](04-data-manipulation.html#discarding-data) the extraneous
...
statements](04-data-manipulation.html#restricting-commands-to-subsets).
...
We will discuss in [Data Manipulation](04-data-manipulation.html) how to edit
...
[later](03-data-management.html#describing-the-data) what these types mean.
...
[value label](03-data-management.html#labeling-values) and the remainder of the
...
the data](02-working-with-data-sets.html#editing-data-manually), after
...
[merging](04-data-manipulation.html#merging-files).
...
[remove](04-data-manipulation.html#discarding-data) some subset of your
...
sets](05-programming.html#linking-data-sets) if interested. You can link data
...
1. Load the [built-in](02-working-with-data-sets.html#built-in-data) data set
   "lifeexp".
2. Open the Data Editor window.
   [Modify](02-working-with-data-sets.html#editing-data-manually) at least one
   of the cells.
3. Close the Data window. Load the built-in data set "sandstone". Don't forget
   to `clear` or pass the `clear` option.
4. [Save a copy](02-working-with-data-sets.html#saving-data) of this data to
   your computer.
    1. Check your [working
       directory](01-the-basics-of-stata.html#working-directory). Make sure it
