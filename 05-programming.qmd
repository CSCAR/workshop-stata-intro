...
Along with the [One Data](01-the-basics-of-stata.html#one-data) principal, Stata
...
[macro](05-programming.html#macros). For example, to calculate the average
...
[`quiet`](05-programming.html#quieting-the-output).)
...
This is similar to [`codebook`](03-data-management.html#summarizing-the-data)
...
. frlink describe diet
  ...
  History:
  -----------------------------------------------------------------------------
    Link variable diet created on 12 Aug 2023 by
...
The loop will create a [macro](05-programming.html#macros) that you name (in the
...
like with [macros](05-programming.html#macros).
...
`-`](03-data-management.html#referring-to-variables).
...
instead](04-data-manipulation.html#replacing-existing-variables). However, if we
...
returns](05-programming.html#class-and-return):
