...
> ar
file https://wwwn.cdc.gov/Nchs/Nhanes/2015-2016/DEMO_I.XPT not .xpt format
r(610);

. frame diet: import sasxport5 "https://wwwn.cdc.gov/Nchs/Nhanes/2015-2016/DR1T
> OT_I.XPT", clear
file https://wwwn.cdc.gov/Nchs/Nhanes/2015-2016/DR1TOT_I.XPT not .xpt format
r(610);

. frame bp: import sasxport5 "https://wwwn.cdc.gov/Nchs/Nhanes/2015-2016/BPX_I.
> XPT", clear
file https://wwwn.cdc.gov/Nchs/Nhanes/2015-2016/BPX_I.XPT not .xpt format
r(610);
...
```stata
. frlink dir
  (no variables created by frlink found)
...
(2000 US Census population by age and sex)
